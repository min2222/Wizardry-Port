...
public class RenderWitheringTotem extends EntityRenderer<EntityWitheringTotem> {
	...
	public RenderWitheringTotem(EntityRendererProvider.Context manager){
		super(manager);
	}

	@Nullable
	@Override
	public ResourceLocation getTextureLocation(EntityWitheringTotem entity){
